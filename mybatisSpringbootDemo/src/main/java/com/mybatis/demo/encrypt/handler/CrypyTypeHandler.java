package com.mybatis.demo.encrypt.handler;
 ...
 * @Version: 1.0
 **/
@MappedTypes(CrypyType.class)
public class CrypyTypeHandler extends BaseTypeHandler<String> {
